...
const statusFlow = ["pending", "waiting_payment", "paid", "dikerjakan", "selesai"];
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "32px 20px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 320px", gap: 24, alignItems: "start" }}>
          ...
          <div>
            ...
            {currentStatus === "paid" && (
              <div style={{ padding: 14, background: "#d1fae5", borderRadius: 14, textAlign: "center" }}>
                <FiCheckCircle style={{ color: "#10b981", fontSize: 20, marginBottom: 4 }} />
                <p style={{ margin: 0, fontSize: 13, fontWeight: 700, color: "#065f46" }}>Pembayaran Lunas</p>
                <p style={{ margin: "4px 0 0", fontSize: 12, color: "#667085" }}>Tunggu tukang mulai bekerja</p>
              </div>
            )}
            ...
            {currentStatus === "selesai" && (
              <>
                ...
                <Link to={`/user/payment/invoice/${booking.id}`} style={{
                  display: "flex", alignItems: "center", justifyContent: "center", gap: 8,
                  width: "100%", padding: 14, background: "white", color: "#026b5e", border: "1px solid #026b5e",
                  borderRadius: 14, fontWeight: 700, fontSize: 14, cursor: "pointer", textDecoration: "none",
                  boxSizing: "border-box"
                }}>
                  <FiCreditCard /> Lihat Invoice
                </Link>
              </>
            )}
          </div>
